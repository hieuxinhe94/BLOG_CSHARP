...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <nav class="navbar navbar-inverse top-navbar" id="top-nav">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="#"><img class="img-responsive" src="https://lh3.googleusercontent.com/-oUUGCaMUjfU/WMp9Omi9qvI/AAAAAAAADQQ/-YPhhaFRGX4r71_eNxo-f4zDU2x0uuskwCJoC/w344-h40-p-rw/logo.png" width="172" height="20"></a>
            ...
            <ul class="social-icon pull-right list-inline">
                ...
                <li class="dropdown">
                    <a class="alerts-link dropdown-toggle" data-toggle="dropdown" href="#">
                        <span class="glyphicon glyphicon-bell">AAAA</span>
    ...
    <div class="container-1" id="user-profil">
        <ul id="side" class="nav navbar-nav-1 side-nav">
            ...
            <li class="side-user">
                <img class="img-circle" src="https://lh3.googleusercontent.com/-UJUmoLiJWLY/WMp8QiPCa3I/AAAAAAAADPg/X-o1iKl1JYUpSVAP8ZoZK4ZiY-EFP5jjwCJoC/w150-h148-p-rw/profile-pic.jpg" alt="sumit kumar">
