        ...
        <div class="col-xs-12 col-sm-offset-3 col-sm-6">
            <div class="panel panel-default">
                ...
                <ul class="list-group" id="contact-list">
                     ...
                     <asp:DataList Width="100%" ID="ddlUsers" OnDeleteCommand="ddlUsers_DeleteCommand" runat="server" DataKeyField="UserId">
                     <EditItemStyle  Width="100%"  />
                            <ItemTemplate>
                             <li class="list-group-item">
                        <div class="col-xs-12 col-sm-3">
                            <img src="../" alt="<%#Eval("UserAccount").ToString() %>" class="img-responsive img-circle" />
                        </div>
                        <div class="col-xs-12 col-sm-9">
                            <span class="name"><%#Eval("UserName").ToString() %></span><br/>
                              <p> <span> <%#Eval("UserEmail") %></span></p> 
                            <p><span> <%#Eval("UserPhone") %></span></p> 
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="mySmallModalLabel">Thêm mới người dùng . chưa hoàn thành</h4>
                </div>
